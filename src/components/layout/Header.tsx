  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: 'white', border: '1px solid #c4c9d0', minWidth: 200,
      }}>
      ...
      {/* Period */}
      <div style={{ display: 'flex', background: 'white', border: '1px solid #c4c9d0', borderRadius: 10, padding: 3, gap: 2 }}>
        {([
          { value: 7, label: '7d' },
          { value: 30, label: '30d' },
          { value: 90, label: '90d' },
      ...
      <div style={{ position: 'relative' }}>
        <div
          ...
          style={{ padding: 8, borderRadius: 10, background: 'white', border: '1px solid #c4c9d0', color: '#64748b', display: 'flex', cursor: 'pointer', position: 'relative' }}
        >
        ...
        {bellOpen && (
          <>
            ...
            <div style={{
              ...
              <div style={{ padding: '12px 16px', borderBottom: '1px solid #cdd0d4' }}>
...
export function Header({ title, subtitle, background = 'rgba(244, 247, 252, 0.85)', titleColor = '#0B081A', subtitleColor = '#94a3b8', userName = 'US', notifications = [] }: HeaderProps) {
  return (
    <header style={{
      ...
      borderBottom: '1px solid #c6cad1', padding: '16px 32px',
