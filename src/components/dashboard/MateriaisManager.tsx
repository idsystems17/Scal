        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            <select
              ...
              style={{ flex: '0 1 140px', padding: '9px 12px', border: '1.5px solid #e2e8f0', borderRadius: 8, fontSize: 13, color: '#0B081A', outline: 'none', background: 'white' }}
            >
            ...
            <input
              ...
              style={{ flex: '1 1 160px', padding: '9px 12px', border: '1.5px solid #e2e8f0', borderRadius: 8, fontSize: 13, color: '#0B081A', outline: 'none' }}
            />
            <input
              value={urlInput}
              onChange={e => setUrlInput(e.target.value)}
              placeholder={PLACEHOLDER_URL[tipoInput]}
              style={{ flex: '2 1 260px', padding: '9px 12px', border: '1.5px solid #e2e8f0', borderRadius: 8, fontSize: 13, color: '#0B081A', outline: 'none' }}
            />
            <button
              onClick={handleAdd}
              disabled={pending}
      ...
      {materiais.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {materiais.map(m => {
            ...
            return (
              <div key={m.id} style={{ display: 'flex', flexDirection: 'column', gap: 10, padding: '12px 14px', borderRadius: 10, border: '1px solid #f1f5f9' }}>
