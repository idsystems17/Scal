...
export function Icon({ name, size = 20, className = '' }: IconProps) {
  ...
  switch (name) {
    ...
    case 'click':
      return <svg {...props}><path d="M9 9l4.5 11.5L15 15l5.5 1L9 9z"/><path d="M9.5 14.5L5 19"/></svg>
    case 'globe':
    ...
    case 'plug':
      return <svg {...props}><path d="M18 16.08c-.76.09-1.5.27-2.17.53M16 7a4 4 0 0 0-4-4 4 4 0 0 0-4 4"/><path d="M12 12v4"/><path d="M8 12H4"/><path d="M20 12h-4"/><circle cx="12" cy="12" r="3"/></svg>
    case 'gear':
