CREATE OR REPLACE VIEW vw_parceiro_dashboard
...
CREATE OR REPLACE VIEW vw_parceiro_tendencia
WITH (security_invoker = on)
AS
SELECT
  l.parceiro_id,
...
CREATE OR REPLACE VIEW vw_cliente_dashboard
WITH (security_invoker = on)
AS
SELECT
  p.cliente_id,
...
CREATE OR REPLACE VIEW vw_admin_dashboard
WITH (security_invoker = on)
AS
SELECT
  c.id AS cliente_id,
